...
public class JavaProject4 {
	...
	public static void main(String[] args) {
		...
		//variables		
		double numDub = doubleMe2(5, 4);
		
		//print out the function
		System.out.println(numDub);		
	}
...
*/
	...
	public static int quadrupleMe(int number) {
		int doubleNum = doubleMe(number);
		return(doubleNum*doubleNum);
	}
	
	public static double doubleMe2(int number, int numTimes) {
	System.out.println("Your initial number is a: " + number);
	return(Math.pow(number, numTimes));
	}
}
